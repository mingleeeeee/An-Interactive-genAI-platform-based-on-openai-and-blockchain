import { decodeEventLog, zeroAddress, getAddress as getAddress$1, toHex, encodeFunctionData, stringToHex, maxUint32, isAddress, createPublicClient, createWalletClient } from 'viem';
...
function getLicenseTermByType(type, term) {
  ...
  if (type === PIL_TYPE.NON_COMMERCIAL_REMIX) {
    ...
    licenseTerms.royaltyPolicy = getAddress$1(term.royaltyPolicyLAPAddress);
    ...
    licenseTerms.currency = getAddress$1(term.currency);
    return licenseTerms;
  } else {
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              return this.ipAssetRegistryClient.register({
                tokenContract: getAddress$1(request.nftContract),
                tokenId: tokenId,
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              _context2.next = 13;
              return this.isRegistered(getAddress$1(parentId));
            case 13:
            ...
            case 29:
              ...
              return this.licenseRegistryReadOnlyClient.hasIpAttachedLicenseTerms({
                ipId: getAddress$1(request.parentIpIds[i]),
                licenseTemplate: request.licenseTemplate && getAddress$1(request.licenseTemplate) || this.licenseTemplateClient.address,
          ...
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 27:
              ...
              return this.licensingModuleClient.registerDerivativeWithLicenseTokens({
                childIpId: getAddress$1(request.childIpId),
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              object = {
                nftContract: getAddress$1(request.nftContract),
                recipient: request.recipient && getAddress$1(request.recipient) || this.wallet.account.address,
                terms: licenseTerm,
                metadata: {
                  metadataURI: "",
                  metadataHash: toHex("", {
              ...
              if (request.metadata && request.metadata.metadataURI && request.metadata.metadata && request.metadata.nftMetadata) {
                object.metadata = {
                  ...
                  metadataHash: toHex(request.metadata.metadata, {
                    size: 32
                  }),
                  nftMetadataHash: toHex(request.metadata.nftMetadata, {
                    size: 32
                  })
                };
              }
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 9:
              ...
              object = {
                ...
                sigAttach: {
                  signer: getAddress$1(request.sigAttach.signer),
              ...
              if (request.sigMetadata && request.sigMetadata.signature && request.sigMetadata.signer && request.sigMetadata.deadline) {
                object.sigMetadata = {
                  signer: getAddress$1(request.sigMetadata.signer),
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 10:
              ...
              _context6.next = 13;
              return this.licenseRegistryReadOnlyClient.hasIpAttachedLicenseTerms({
                ipId: getAddress$1(request.derivData.parentIpIds[i]),
                licenseTemplate: request.derivData.licenseTemplate && getAddress$1(request.derivData.licenseTemplate) || this.licenseTemplateClient.address,
            ...
            case 19:
              object = {
                ...
                sigRegister: {
                  signer: getAddress$1(request.sigRegister.signer),
              ...
              if (request.sigMetadata && request.sigMetadata.signature && request.sigMetadata.signature.length > 0 && request.sigMetadata.signer && request.sigMetadata.signer !== zeroAddress && request.sigMetadata.deadline !== 0n) {
                object.sigMetadata = {
                  signer: getAddress$1(request.sigMetadata.signer),
                  deadline: BigInt(request.sigMetadata.deadline),
                  signature: request.sigMetadata.signature
          ...
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              return this.ipAssetRegistryClient.ipId({
                chainId: chain[this.chainId],
                tokenContract: getAddress$1(nftContract),
      ...
      var _setPermission = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              ipAccountClient = new IpAccountImplClient(this.rpcClient, this.wallet, getAddress$1(request.ipId));
              _context.next = 4;
              return ipAccountClient.execute({
                ...
                data: encodeFunctionData({
                  abi: accessControllerAbi,
                  functionName: "setPermission",
                  args: [getAddress$1(request.ipId),
                  // 0x Address
                  getAddress$1(request.signer),
                  // 0x Address
                  getAddress$1(request.to),
                  // 0x Address
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return this.ipAssetRegistryClient.isRegistered({
                id: getAddress$1(request.licensorIpId)
              });
            case 4:
            ...
            case 17:
              ...
              return this.licensingModuleClient.mintLicenseTokens({
                ...
                receiver: request.receiver && getAddress$1(request.receiver) || this.wallet.account.address,
                royaltyContext: zeroAddress
              });
            case 19:
              txHash = _context5.sent;
      ...
      var _execute = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              ipAccountClient = new IpAccountImplClient(this.rpcClient, this.wallet, getAddress$1(request.accountAddress));
              _context.next = 4;
              return ipAccountClient.execute({
                to: request.to,
                value: BigInt(0),
    ...
    value: (function () {
      var _getIpAccountNonce = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(ipId) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ipAccount = new IpAccountImplClient(this.rpcClient, this.wallet, getAddress$1(ipId));
              _context3.next = 3;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.ipAssetRegistryClient.isRegistered({
                id: getAddress$1(request.parentIpId)
              });
            case 3:
            ...
            case 6:
              _context.next = 8;
              return this.getRoyaltyVaultAddress(getAddress$1(request.royaltyVaultIpId));
            case 8:
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.ipAssetRegistryClient.isRegistered({
                id: getAddress$1(request.receiverIpId)
              });
            case 3:
            ...
            case 6:
              _context2.next = 8;
              return this.ipAssetRegistryClient.isRegistered({
                id: getAddress$1(request.payerIpId)
              });
            case 8:
            ...
            case 11:
              ...
              return this.royaltyModuleClient.payRoyaltyOnBehalf({
                ...
                token: getAddress$1(request.token),
          ...
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              return ipRoyaltyVault.claimableRevenue({
                account: getAddress$1(request.account),
          ...
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              return this.ipAccountClient.execute({
                to: proxyAddress,
                value: 0,
                accountAddress: getAddress$1(request.account),
                txOptions: {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return this.ipAssetRegistryClient.isRegistered({
                id: getAddress$1(royaltyVaultIpId)
              });
            case 2:
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return this.spgClient.createCollection({
                ...
                mintToken: (_request$mintToken = request.mintToken) !== null && _request$mintToken !== void 0 ? _request$mintToken : zeroAddress,
                owner: request.owner && getAddress$1(request.owner) || this.wallet.account.address
              });
            case 5:
              txHash = _context.sent;
              if (!((_request$txOptions = request.txOptions) !== null && _request$txOptions !== void 0 && _request$txOptions.waitForTransaction)) {
...
export { AddressZero, DisputeClient, HashZero, IPAssetClient, LicenseClient, NftClient, PermissionClient, StoryClient };
